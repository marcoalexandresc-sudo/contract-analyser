...
export async function POST(request: NextRequest) {
  try {
    ...
    // Verify code and check analysis limit
    ...
    // Convert PDF to base64 - Claude reads it natively, no pdf-parse needed
    ...
    await resend.emails.send({
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 40px 20px;">
          ...
          <p style="color: #6b7280; font-size: 12px; margin-top: 24px;">Contract Analyser · Demo Application · Marco Costa</p>
        </div>
      `
    })
