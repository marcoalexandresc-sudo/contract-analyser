          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <div style={{ fontFamily: "'Georgia', 'Times New Roman', serif", fontSize: '13px', lineHeight: '1.8', color: '#1a1a2e' }}>
              <ReactMarkdown
                components={{
                  ...
                  ul: ({children}) => <ul style={{ marginBottom: '12px', paddingLeft: '18px', listStyle: 'disc' }}>{children}</ul>,
                  ol: ({children}) => <ol style={{ marginBottom: '12px', paddingLeft: '16px' }}>{children}</ol>,
                  li: ({children}) => <li style={{ fontSize: '13px', color: '#374151', marginBottom: '5px', lineHeight: '1.6' }}>{children}</li>,
            ...
            <div className="mt-8 pt-4 border-t border-gray-100">
              <p className="text-gray-400 text-xs leading-relaxed">
                <strong>Disclaimer:</strong> This analysis is generated by AI and is intended
